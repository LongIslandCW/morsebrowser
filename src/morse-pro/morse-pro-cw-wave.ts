...
export default class MorseCWWave extends MorseCW {
     ...
     */
    constructor(useProsigns=true, wpm=20, fwpm=20, frequency = 550, sampleRate = 8000) {
    ...
    getWAASample(endPadding = 0) {
        ...
        var offlineAudioContextClass = window.OfflineAudioContext || (window as any).webkitOfflineAudioContext;
